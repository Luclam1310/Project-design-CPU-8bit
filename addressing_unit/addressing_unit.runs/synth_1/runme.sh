...
HD_PWD='D:/Electronic and Telecomunication/RTL_design/CPU design/addressing_unit/addressing_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AddressingUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AddressingUnit.tcl
