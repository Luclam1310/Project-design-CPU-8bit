...
HD_PWD='D:/Electronic and Telecomunication/RTL_design/CPU design/addressing_unit/addressing_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AddressingUnit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AddressingUnit.tcl -notrace
